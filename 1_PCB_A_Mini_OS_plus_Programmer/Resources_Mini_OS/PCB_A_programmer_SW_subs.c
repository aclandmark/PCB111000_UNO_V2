...
if(prog_led_control & 0b00001000) {led_on;}	
else {led_off;}}  
...
/**********************************************************************************************************/
void USART_Rx_init (unsigned char UBRROH_N, unsigned char UBRR0L_N ){
{five_msec_delay;}			//REDUCE to 5mS
UCSR0B = 0;
UBRR0H = UBRROH_N;
UBRR0L = UBRR0L_N; 
UCSR0A = (1 << U2X0);
...
/**********************************************************************************************************/
void timer_T0_sub_x_M(char Counter_speed, char Start_point, char cycles){ 
