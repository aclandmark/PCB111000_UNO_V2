/*
"Flash_verification" is designed for use with the "PCB_A programmer".
"Flash_verification" starts at address 0x5E00 and is reached via a jump command
located at the end of the PCB_programmer.  Normal HW setup is not therefore required.
Data passed between the programmer and read routines is placed in EEPROM
...
int main (void){
	...
	else 																//Hex_text bootloader config bytes
	...
	Reset_H;															//Reset line remains high until SW_reset takes
