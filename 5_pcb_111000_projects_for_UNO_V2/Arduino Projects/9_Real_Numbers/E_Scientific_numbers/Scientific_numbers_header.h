...
/************************************************************************************************************/
#define line_control {if(line_counter==4) {line_counter = 0;newline_A();}\
...
#define enable_up_pci_on_sw1_and_sw2    PCMSK2 |= (1 << PCINT18) | (1 << PCINT23);
...
#include "UNO_proj_resources/PC_comms/Real_num_resources.c"
#include "UNO_proj_resources/PC_comms/rounding.c"
